...
$PayRequestFields = array(
						...
						'CancelURL' => 'http://localhost/paypal/class/1.2/Pay_Cancel.php', 									// Required.  The URL to which the sender's browser is redirected if the sender cancels the approval for the payment after logging in to paypal.com.  1024 char max.
						...
						'PreapprovalKey' => 'PA-0TL47618NL213103X', 							// The key associated with a preapproval for this payment.  The preapproval is required if this is a preapproved payment.  
						'ReturnURL' => 'http://localhost/paypal/class/1.2/Pay_Return.php', 									// Required.  The URL to which the sener's browser is redirected after approvaing a payment on paypal.com.  1024 char max.
