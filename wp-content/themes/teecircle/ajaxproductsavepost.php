...
?>
<?php 
if(isset($_POST['campain_title']) && !empty($_POST['campain_title'])){
	$campain_title = $_POST['campain_title'];
}else{
	$campain_title = 'Untitled';
}
