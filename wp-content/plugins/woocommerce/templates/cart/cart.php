			...
			<td colspan="6" class="actions">
				...
				<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<label for="coupon_code"><?php _e( 'Coupon', 'woocommerce' ); ?>:</label> <input name="coupon_code" class="input-text" id="coupon_code" value="" /> <input type="submit" class="cmnBtn" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
				...
				<input type="submit" class="cmnBtn" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="cmnBtn" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
